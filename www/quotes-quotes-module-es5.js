...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["quotes-quotes-module"], {
  ...
  function srcAppPagesQuotesQuotesPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var QuotesPage = /*#__PURE__*/function () {
      function QuotesPage(router, api, activatedRoute) {
      ...
      _createClass(QuotesPage, [{
        ...
        key: "searchChanged",
        value: function searchChanged(author) {
          this.author = author.detail.value;
          this.router.navigateByUrl("/tabs/quotes/".concat(author));
    ...
    }), tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _services_api_service__WEBPACK_IMPORTED_MODULE_3__["ApiService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"]])], QuotesPage);
    /***/
  }
}]);
